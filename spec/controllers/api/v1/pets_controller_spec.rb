...
RSpec.describe Api::V1::PetsController, type: :controller do
  ...
  # Api::V1::PetsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created api/v1_pet" do
        post :create, params: {api/v1_pet: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Api::V1::Pet.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the api/v1_pet" do
        pet = Api::V1::Pet.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the api_v1_pets list" do
      pet = Api::V1::Pet.create! valid_attributes
      delete :destroy, params: {id: pet.to_param}, session: valid_session
      expect(response).to redirect_to(api_v1_pets_url)
    end
  end
